        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div style="margin-bottom:20px; width:300px">
                    ...
                    <form class="form-role hide" action="{{ Route('admin.master.acl-store-role') }}" method="post">
                        {{ csrf_field() }}

                        <input type="text" class='form-control' name="nome" placeholder='Nome da role'>
                        <input type="text" class='form-control' name="descricao" placeholder='Descrição da role'>
                        <br>
                            ...
                            <tbody>
                                @foreach($data['roles'] as $value)
                                    <tr>
                        	            ...
                        	            <td style="width:50px"><a href='{{ Route('admin.master.acl-delete-role', $value->id) }}' class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
