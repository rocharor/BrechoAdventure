...
@section('content')
    <div id='el-edit-product' class='hide'>
        <!--BREADCRUMB-->
        <div id='breadcrumb'>
        ...
        <div class='formulario'>
            ...
            <form action="{{ Route('minha-conta.product-update') }}" method="post" name="formEditarProduto" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                @if ($produto->status == 1)
                    <a href='{{ Route('product-view',$produto->slug) }}' class="btn btn-info">Visualizar</a>
                @else
