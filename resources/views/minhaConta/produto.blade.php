        ...
        @else
            @foreach ($meusProdutos as $produto)
                <div class="col-md-3 col-xs-12 div-meus-produtos" align="center">
                    ...
                    {{-- Produto inativado --}}
                    @if ($produto->status == 0)
                        <div class='div_imagem'><img src="/imagens/produtos/200x200/{{ $produto->imgPrincipal }}" style="filter: contrast(5%);"></div>
                        <br>
                        <div class='btn_acoes'>
                    ...
                    {{-- Produto pendente --}}
                    @elseif ($produto->status == 2)
                        <div class='div_imagem' ><img src="/imagens/produtos/200x200/{{ $produto->imgPrincipal }}" style="filter: grayscale(100%)"></div>
                        <br>
                        <div class='btn_acoes'>
